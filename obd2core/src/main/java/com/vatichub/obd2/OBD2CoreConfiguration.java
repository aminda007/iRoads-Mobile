...
import com.vatichub.obd2.logging.FileIO;
...
public class OBD2CoreConfiguration {
	...
	private List<String> allPIDsList;
	private List<String> supportedPIDsList;
	
	private List<String> queryPIDsList;
    private List<String> requestedPIDsList;
    /*
	...
	private List<String> loggingParamsList;
    ...
    private List<FileIO> openFileList;
	...
	private OBD2CoreConfiguration(Context context){
    ...
    public static void init(Context context)  {
        ...
        OBD2SiddhiAgentManager.init();
        OBD2EventManager.init();
    }

    private static void initInstance(Context context){
        instance=new OBD2CoreConfiguration(context);
    }
	...
	public List<String> getAllPIDsList() {
		return allPIDsList;
	}
	...
	public void setSupportedPIDsList(List<String> supportedPIDsList) {
	...
	public void setExiting(boolean exitting) {
	...
	public List<FileIO> getOpenFileList() {
		return openFileList;
	}
	...
	public List<String> getQueryPIDsList() {
    ...
    public List<String> getRequestedPIDsList() {
