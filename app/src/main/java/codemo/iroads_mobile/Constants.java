...
public class Constants {
	...
	public static final double GAUGE_METER_VALUE_TEXT_SIZE = 30;

	public static final double DIGITAL_METER_TEXT_SIZE_MAX = 120;
	public static final double DIGITAL_METER_WIDTH_HEIGHT_FACTOR = 0.4;
	public static final double DIGITAL_METER_WIDTH_HEIGHT_FACTOR_ADJUST = -0.3;
	...
	public static final String DISPLAYS_DEFAULT  = "Digital_Display:obd2_speed,Digital_Display:obd2_engine_rpm " +
			...
			"Dial_Display:obd2_MAF Line_Graph:obd2_MAF,Line_Graph:obd2_speed,Dial_Display:obd2_MAF Dial_Display:obd2_engine_temp,Line_Graph:obd2_fuelrate";
	...
	public static final String VINLI = "vinli";
